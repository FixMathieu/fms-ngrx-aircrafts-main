...
export enum AircraftsActionsTypes{
    ...
    SEARCH_AIRCRAFTS_ERROR = "[Aircrafts] Search Aircrafts Error",  
     ...
     //Action : Get Production aircrafts
     GET_PRODUCTION_AIRCRAFTS = "[Aircrafts] Get Production Aircrafts",
     GET_PRODUCTION_AIRCRAFTS_SUCCESS = "[Aircrafts] Get Production Aircrafts Success",
     GET_PRODUCTION_AIRCRAFTS_ERROR = "[Aircrafts] Get Production Aircrafts Error", 
}
...
//Get Development/search aircrafts
...
//Get Production aircrafts
export class GetProductionAircraftsAction implements Action {
    type: AircraftsActionsTypes = AircraftsActionsTypes.GET_PRODUCTION_AIRCRAFTS;
    constructor(public payload:any) {   
    }
}
export class GetProductionAircraftsActionSuccess implements Action {
    type: AircraftsActionsTypes = AircraftsActionsTypes.GET_PRODUCTION_AIRCRAFTS_SUCCESS;
    constructor(public payload:Aircraft[]) {
    }
}
export class GetProductionAircraftsActionError implements Action {
    type: AircraftsActionsTypes = AircraftsActionsTypes.GET_PRODUCTION_AIRCRAFTS_ERROR;
    constructor(public payload:string) {   //message d'erreur
    }   
}
...
SearchAircraftsAction | SearchAircraftsActionSuccess | SearchAircraftsActionError | GetProductionAircraftsAction | GetProductionAircraftsActionError | GetProductionAircraftsActionSuccess;