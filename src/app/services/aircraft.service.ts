...
export class AircraftService {
  ...
  //liste des avions en phase de production 
  public getProductionAircrafts():Observable<Aircraft[]>{
    return this.http.get<Aircraft[]>(environment.host+"/aircrafts?production=true");
  }
